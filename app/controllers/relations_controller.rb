class RelationsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to relations_path, status: :see_other, notice: "Relation was successfully destroyed." }
  ...
  private
    ...
    def relation_params
      params.require(:relation).permit(:main_card_id, :sub_card_id, :point)
    end
end
